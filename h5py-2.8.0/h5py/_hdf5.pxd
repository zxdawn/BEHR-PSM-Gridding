...
cdef extern from "hdf5.h":
  ...
  IF HDF5_VERSION >= (1, 8, 11):
      herr_t H5DOwrite_chunk(hid_t dset_id, hid_t dxpl_id, uint32_t filters, const hsize_t *offset, size_t data_size, const void *buf) except *
  ...
  IF HDF5_VERSION >= (1, 8, 9):
      ssize_t H5Fget_file_image(hid_t file_id, void *buf_ptr, size_t buf_len) except *
  IF HDF5_VERSION >= (1, 8, 9):
      IF MPI:
  ...
  IF HDF5_VERSION >= (1, 8, 9):
      herr_t H5Pset_file_image(hid_t plist_id, void *buf_ptr, size_t buf_len) except *
